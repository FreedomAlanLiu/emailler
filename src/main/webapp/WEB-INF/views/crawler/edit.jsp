...
<body>
<form:form id="inputForm" action="${ctx}/crawlers/${crawler.id}" method="post" modelAttribute="crawler" cssClass="form-horizontal">
    <form:hidden path="id" />
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input id="websiteUrl" path="websiteUrl" cssClass="input-xxlarge required" minlength="5" />
            </div>
        </div>
        <div class="control-group">
